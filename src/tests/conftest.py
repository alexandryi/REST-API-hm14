...
DATABASE_URL = os.getenv("DATABASE_URL", "DATABASE_URL=postgresql+asyncpg://postgres:melnyk2006@localhost:5432/db_contacts_fin")
...
def event_loop():
    """Створюємо цикл подій для всієї сесії тестів"""
...
@pytest.fixture
async def client(override_get_db, override_get_current_user):
    """Фікстура клієнта для тестів"""
